...
[![x-cmd/install — pageres-cli Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/pageres-cli.svg)](https://x-cmd.com/install/pageres-cli)
...
Total: **318** lines of code across **4** files in the top 5 languages.
...
- **Upstream**: <https://github.com/sindresorhus/pageres-cli>
- **License**: MIT
...
- **Stars**: 1,744 · **Forks**: 72 · **Open issues**: 0 · **Contributors**: 18

## Totals (cumulative)

- **Releases**: 12 · **Merged PRs**: 6 · **Open PRs**: 0 · **Closed issues**: 0 · **Open issues**: 0 · **Commits**: 220
...
_Snapshot: `data/card/260924.yml` · 2026-09-24T04:50:35Z._
